...
const index$1 = require("./index-1knwIwcC.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-HMyvoCLV.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-HMyvoCLV.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-g159lp7f.js.map
