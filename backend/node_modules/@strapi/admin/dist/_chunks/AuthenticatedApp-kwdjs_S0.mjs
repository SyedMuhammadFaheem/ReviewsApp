...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-XBOTBNuC.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.16.0",
  "@strapi/permissions": "4.20.5",
  "@strapi/provider-audit-logs-local": "4.20.5",
  "@strapi/types": "4.20.5",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.20.5",
  "@strapi/data-transfer": "4.20.5",
  "@strapi/pack-up": "4.20.5",
  "@strapi/plugin-content-manager": "4.20.5",
...
const CM = React.lazy(
  () => import("./index-XBOTBNuC.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-KVErLS68.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-4ekFFFnc.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-3SjeOIl9.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-XBOTBNuC.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-p-ihQgkq.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-Ib7N7CWP.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-kwdjs_S0.mjs.map
