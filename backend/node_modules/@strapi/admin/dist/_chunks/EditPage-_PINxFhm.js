...
const useWebhooks = require("./useWebhooks--d-jYykj.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-7jWjBOCM.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-_PINxFhm.js.map
