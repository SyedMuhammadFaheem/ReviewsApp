...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-XBOTBNuC.mjs";
...
import { u as useWebhooks } from "./useWebhooks-0L1K3yUR.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-8U1cTmXv.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-pgD1DzOE.mjs.map
